...
  
  const SHEETDB_URL = "https://sheetdb.io/api/v1/1gagsabcrg9xb"; 
  const WHATSAPP_GROUP_LINK = "https://chat.whatsapp.com/KzvDs2W2qjkKEuZjbN1cE3"; 
  // --- Updated Footer Data ---
  const CONTACT_EMAIL = "contact@droidclub.com"; 
  const SOCIAL_LINKS = {
      twitter: "#",
...
            {/* MAIN TITLE */}
            <h1 className="text-4xl sm:text-7xl font-extrabold leading-tight tracking-tight font-sans">
              APPLY NOW
              <br />
...
                      <button
                          type="submit"
                          disabled={loading || !formData.joinWhatsapp}
                          className={`
                            bg-purple-600 
                            ...
                            ${loading
                              ...
                              : (!formData.joinWhatsapp ? 'opacity-50 cursor-not-allowed' : 'hover:bg-purple-700 shadow-[0_0_25px_rgba(139,43,226,0.6)]')
                            }
                          `}>
...
            <h3 className="text-5xl font-extrabold text-purple-400 mb-8">Contact & Location</h3>
            
...
                                    className="flex items-center text-lg font-mono transition hover:text-purple-400"
                                >
...
                    <div className="flex items-start text-lg text-white/90 mt-4">
...
                    
                    {/* General Email */}
                    <a href={`mailto:${CONTACT_EMAIL}`} className="flex items-center text-lg font-medium transition hover:text-purple-400 mt-6">
...
            {/* Social Media Icons - Still Centered */}
